...
using AnunturiAPI.Providers;
using AnunturiAPI.Results;
...
namespace AnunturiAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            {
                return BadRequest(string.Join(", ", userResult.Errors));
            }

            var userId = UserManager.FindByEmail(user.Email).Id;

            var roleResult = await UserManager.AddToRoleAsync(userId, model.Role);
